...
[![Build Status](https://img.shields.io/github/actions/workflow/status/BlackRoad-OS/ray/deploy.yml?branch=main)](https://github.com/BlackRoad-OS/ray/actions) [![License: Proprietary](https://img.shields.io/badge/License-Proprietary-red.svg)](LICENSE) [![Brand Compliant](https://img.shields.io/badge/Brand-Compliant-success)](https://brand.blackroad.io)
...
git clone https://github.com/BlackRoad-OS/ray.git
...
4. Custom domain: ray.pages.dev

**Live URL:** https://ray.pages.dev
...
- **Issues:** https://github.com/BlackRoad-OS/ray/issues
